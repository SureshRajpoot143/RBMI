    ...
    <footer className="bg-gray-900 text-white py-12" style={{maxWidth: '100%', overflow: 'hidden', backgroundColor: '#f1eaea1d',tranprency:'0.9' }}>
      <div  className="container mx-auto px-4"  >
        <div className="grid md:grid-cols-3 gap-8" >
          <div >
            <h1 >RBMI WORLD</h1>
          <h1><p>Creating positive change through education, healthcare, and community support worldwide.</p></h1>  
          </div>
          <div className="text-center">
            <h3 className="text-xl font-semibold mb-4">Quick Links</h3>
            <ul className="center space-y-2 list-none">
              <li className="text-center"><a href="#about" className="hover:text-blue-300 transition-colors">About Us</a></li>
              <li className="text-center"><a href="#donate" className="hover:text-blue-300 transition-colors">Donate</a></li>
              <li className="text-center"><a href="#impact" className="hover:text-blue-300 transition-colors">Our Impact</a></li>
              <li className="text-center"><a href="#contact" className="hover:text-blue-300 transition-colors">Contact</a></li>
            </ul>
          </div>
          <div >
            <b><h3 className="text-xl font-semibold mb-4">Stay Connected</h3></b>
            <div className='center'>
              <a href="https://www.facebook.com/RbmiGroupofInstitution/" className="footer-icon" aria-label="Facebook">
              ...
              <a href="https://x.com/rbmigi" className="footer-icon" aria-label="Twitter">
              ...
              <a href="https://www.instagram.com/rbmigroup/?hl=en" className="footer-icon" aria-label="Instagram">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>©️ 2025 RBMI WORLD. All rights reserved.</p>
        </div>
      </div>
    </footer>
     </section>
